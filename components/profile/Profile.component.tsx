    ...
    <div className="my-5 flex items-center justify-center">
      <div className="bg-red-500 p-10 rounded-lg shadow-lg">
        <div className="text-center">
          <div className="flex space-x-2">
            ...
            <span className="flex justify-between w-full">
              ...
              <span className="py-2 text-slate-50 font-semibold text-sm">
                <EditFilled className="cursor-pointer hover:scale-125 duration-200 transition-all" />
              </span>
            </span>
          </div>
          <div className="flex space-x-2">
          ...
          <div className="flex items-center justify-center mt-7 cursor-pointer hover:scale-105 duration-200 transition-all">
            <p
